(function() {
  ...
  QUnit.test('filter', function(assert) {
    ...
    assert.deepEqual(_.filter(list, {
      a: 1
    }), [{
      a: 1,
      b: 2
  ...
  QUnit.test('reject', function(assert) {
    ...
    assert.deepEqual(_.reject(list, {
      a: 1
    }), [{
      a: 2,
      b: 2
  ...
  QUnit.test('findWhere', function(assert) {
    ...
    function test() {}
    test.map = _.map;
    assert.strictEqual(_.findWhere([_, {
      a: 1,
      b: 2
  ...
  QUnit.test('max', function(assert) {
    ...
    assert.deepEqual(_.map([
      [1, 2, 3],
      [4, 5, 6]
    ], _.max), [3, 6], 'Finds correct max in array when mapping through multiple arrays');
  ...
  QUnit.test('min', function(assert) {
    ...
    assert.deepEqual(_.map([
      [1, 2, 3],
      [4, 5, 6]
    ], _.min), [1, 4], 'Finds correct min in array when mapping through multiple arrays');
  ...
  QUnit.test('sample', function(assert) {
    ...
    assert.ok(_.contains([1, 2, 3], _.sample({
      a: 1,
      b: 2,
      c: 3
  ...
  QUnit.test('partition', function(assert) {
    ...
    // Default iterator
    assert.deepEqual(_.partition([1, false, true, '']), [
      [1, true],
      [false, '']
    ], 'Default iterator');
    assert.deepEqual(_.partition([{
    ...
    assert.deepEqual(_.partition([1, 2, 3], predicate, {
      x: 2
    }), [
      [2],
      [1, 3]
